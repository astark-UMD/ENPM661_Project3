...
def main():
    ...
    start_x, start_y, start_theta = get_point(prompt="start", sf=sf, image=expanded_obstacle_map2, obstacles=obs_map_gray)
    end_x, end_y, end_theta = get_point(prompt="end", sf=sf, image=expanded_obstacle_map2, obstacles=obs_map_gray)

    start_theta = -start_theta % 360
    end_theta = -end_theta % 360
